...
these operations. That is, implement the method track(int x), which is called when each number is generated, and 
the methos getRankOfNumber(int x), which returns the number of values less than or equal to x
